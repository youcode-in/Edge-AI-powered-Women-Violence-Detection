...
//        person2 +=1;
        ...
        double v1 = x;
//        double v3 = x;
//        g_print("person1-%d-value- %f\n", j,v1);
        if (j == 8) 
        {
//	 g_print("person1 point %f\n", v1);
         g_print("person1-%d-value- %f\n", j,v1);
         p1 = v1;
        }
/*        if (j == 10)
...
//        g_print("x%dvalue- %f\n", j,v1);
      ...
      if (k == 1)
      {
        ...
        cparams.yc = y;
        double v2 = x;
//        g_print("person2-%d-value- %f\n", j,v2);

        if (j == 10) 
        {
//	 g_print("person2 point %f\n", v2);
         g_print("person2-%d-value- %f\n", j,v2);
         p3 = v2;
        }
        cparams.radius = 8;
...
//  if (value >= 432 && value <= 435)
  if (value >= 260 && value <= 290)
  {
   prt = 1;
   p1 = 0;
   p3 = 0;
                          ...
                          gpointer u_data)
{
       ...
       l_frame = l_frame->next)
  {
    ...
    if (prt == 1) {
	    ...
	    offset = snprintf (txt_params->display_text, MAX_DISPLAY_LEN, "Punch");
